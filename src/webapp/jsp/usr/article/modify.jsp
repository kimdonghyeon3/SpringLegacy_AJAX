    ...
    <div class="container px-3 mx-auto">
        ...
        <form method="POST" onsubmit="ArticleSave__submitForm(this); return false;">
            ...
            <div class="flex gap-3">
                <span>제목</span>
                <div>
                    <input class="mb-[15px]" name="title" type="text" maxlength="50" placeholder="제목을 입력해주세요." value="${article.title}" />
                </div>
            </div>
            ...
            <div class="flex gap-3">
                <span>내용</span>
                <div>
                    <input class="mb-[15px]" name="body" type="text" maxlength="300" placeholder="내용을 입력해주세요." value="${article.body}" />
                </div>
            </div>
